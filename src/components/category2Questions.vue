<template>
  <div id="cat2QuestionsStack">
    ...
    <v-layout
    class="mt-4"
    v-for="(oCQuestion, index) in categoryWychowanieMetodaMetodyki.oneChoiceQuestions"
    :key="index">
      <v-flex>
        <v-card hover>
    ...
    <v-layout
    class="mt-4"
    v-for="(mCQuestion, index) in categoryWychowanieMetodaMetodyki.multiChoiceQuestions"
    :key="index">
      <v-flex>
        <v-card hover>
          <v-card-text primary-title>
    ...
    <v-layout
    class="mt-4"
    v-for="(vBQuestion, index) in categoryWychowanieMetodaMetodyki.videoBasedQuestions"
    :key="index">
      <v-flex>
        <v-card hover>
          <v-card-text primary-title>
    ...
    <v-layout
    class="mt-4"
    v-for="(iBQuestion, index) in categoryWychowanieMetodaMetodyki.imageBasedQuestions"
    :key="index">
      <v-flex>
        <v-card hover>
          <v-card-text primary-title>
    ...
    <v-layout
    class="mt-4"
    v-for="(tFQuestion, index) in categoryWychowanieMetodaMetodyki.textFieldQuestions"
    :key="index">
      <v-flex>
        <v-card hover>
