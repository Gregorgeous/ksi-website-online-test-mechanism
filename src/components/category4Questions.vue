<template>
  <div id="cat4QuestionsStack">
    ...
    <v-layout class="mt-4" v-for="oCQuestion in categoryIdeaIHistoria.oneChoiceQuestions" :key="oCQuestion.question">
      <v-flex>
        <v-card hover>
    ...
    <v-layout class="mt-4" v-for="mCQuestion in categoryIdeaIHistoria.multiChoiceQuestions" :key="mCQuestion.question">
      <v-flex>
        <v-card hover>
          <v-card-text primary-title>
            <v-layout>
    ...
    <v-layout class="mt-4" v-for="vBQuestion in categoryIdeaIHistoria.videoBasedQuestions" :key="vBQuestion.question">
      <v-flex>
        <v-card hover>
          <v-card-text primary-title>
            <v-layout row>
    ...
    <v-layout class="mt-4" v-for="iBQuestion in categoryIdeaIHistoria.imageBasedQuestions" :key="iBQuestion.question">
      <v-flex>
        <v-card hover>
          <v-card-text primary-title>
            <v-layout row>
              <v-flex>
                ...
                <!-- <iframe class="text-xs-center" id="testImage" :src="iBQuestion.imageURLs" width="100%" height="400px">
                </iframe> -->
              </v-flex>
            </v-layout>
            <v-layout row>
            ...
            <!-- TODO: what;s below might be a future option for allowing one-choice/multi-choice questions for questions with image -->
            <!-- <v-layout row>
              <v-flex>
    ...
    <v-layout class="mt-4" v-for="tFQuestion in categoryIdeaIHistoria.textFieldQuestions" :key="tFQuestion.question">
      <v-flex>
        <v-card hover>
